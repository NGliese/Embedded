...
uint16_t basic_utils::leastSignificantByteExchange(uint16_t data,
        uint8_t exchange) {
...
uint32_t basic_utils::shift8BitTo32(const uint8_t& b1, const uint8_t& b2,
        const uint8_t& b3, const uint8_t& b4) {
    return  (b1 << 24 | b2 << 16 | b3 << 8 | b4);
}

general_err_t basic_utils::shift32BitTo8(const uint32_t& b32, uint8_t& b1,
