...
class RPICamV2 final : public Camera_CV
{
  ...
  public:
	...
	/**
	 * function to set exposure time for the resperry pi cam v2
	 * @param [in] exposure : 0  - 100
	 */
	general_err_t setExposure(const uint8_t& exposiure);
...
{
  public:
	explicit friend_RPICamV2(RPICamV2* RPICamV2) : m_sensor{RPICamV2} {};
