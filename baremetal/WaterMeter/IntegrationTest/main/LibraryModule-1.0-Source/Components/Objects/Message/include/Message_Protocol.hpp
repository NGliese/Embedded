...
class Message_Protocol
{
  public:
	...
	inline static size_t parameterCount(void)
	{
		return 5;
	}; // id + flag + 2xtime + data = 5
	inline static size_t controlParameterCount(void)
	{
		return 2;
	}; // id + flag  = 2
	inline static size_t dataParameterCount(void)
	{
		return 3;
	}; // 2xtime + data = 3
  private:
