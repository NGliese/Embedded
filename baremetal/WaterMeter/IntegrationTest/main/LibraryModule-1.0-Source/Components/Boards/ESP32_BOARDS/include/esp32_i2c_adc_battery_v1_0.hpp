...
constexpr GPIO_PIN ADC_BATTERY = GPIO_NUM_33; // might change to adc_pin
constexpr GPIO_PIN ADC_SENSOR = GPIO_NUM_34; // might change to adc_pin
constexpr GPIO_PIN ON_OFF_SENSOR = GPIO_NUM_27;
#else
constexpr GPIO_PIN I2C_SDA = 13;
constexpr GPIO_PIN I2C_SCLK = 21;
constexpr GPIO_PIN ADC_BATTERY = 33;
constexpr GPIO_PIN ADC_SENSOR = 34;
