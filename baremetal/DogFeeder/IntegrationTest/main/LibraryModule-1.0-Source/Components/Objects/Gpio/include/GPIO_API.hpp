...
public:
    ...
    bool isHigh() const;
    bool isLow() const;
    general_err_t installInterrupt(const GPIO_HAL::io_intr_t& type,  void (*callbackfunction)(void*) );

    general_err_t enableInterrupt(void) { return m_hal.enableInterrupt(m_pin); };
    general_err_t disableInterrupt(void) { return m_hal.disableInterrupt(m_pin); };
