...
enum class db_id{
        /* DEBUG SENSOR */
        DEBUG_ID1,DEBUG_ID2,DEBUG_ID3,DEBUG_ID4,DEBUG_ID5,DEBUG_ID6,DEBUG_ID7,DEBUG_ID8,DEBUG_ID9,
        /* Window Detector */
        WINDOW_DETECT_OFFICE1,WINDOW_DETECT_BEDROOM1,WINDOW_DETECT_GYM1,WINDOW_DETECT_GYM2, WINDOW_DETECT_LIVINGROOM1,WINDOW_DETECT_KITCHEN1,
        /* ENV - SKUR */
        ENV_SKUR_TEMP1, ENV_SKUR_HUM1,

        /* GreenHouse Sensing */
        GH_AMBIENT_TEMP,GH_AMBIENT_HUM,GH_AMBIENT_LIGHT,GH_AMBIENT_C02,GH_WATER_LEVEL,GH_MOIST1,GH_MOIST2,GH_MOIST3,GH_MOIST4,
...
static const std::map<db_id,uint32_t> map {
    {db_id::DEBUG_ID1, 1 }, {db_id::DEBUG_ID2, 2 }, {db_id::DEBUG_ID3, 3 },{db_id::DEBUG_ID4, 4 },{db_id::DEBUG_ID5, 5 },{db_id::DEBUG_ID6, 6 },{db_id::DEBUG_ID7, 7 },{db_id::DEBUG_ID8, 8 },{db_id::DEBUG_ID9, 9 },
    {db_id::WINDOW_DETECT_OFFICE1, 10 }, {db_id::WINDOW_DETECT_BEDROOM1, 11 }, {db_id::WINDOW_DETECT_GYM1, 12 },{db_id::WINDOW_DETECT_GYM2, 13 },{db_id::WINDOW_DETECT_LIVINGROOM1, 14 },{db_id::WINDOW_DETECT_KITCHEN1, 15 },
    {db_id::ENV_SKUR_TEMP1, 16 }, {db_id::ENV_SKUR_HUM1, 17 },
    {db_id::GH_AMBIENT_TEMP, 18 },{db_id::GH_AMBIENT_HUM, 19 },{db_id::GH_AMBIENT_LIGHT, 20 },{db_id::GH_AMBIENT_C02, 21 },{db_id::GH_WATER_LEVEL, 22 },
    {db_id::GH_MOIST1, 23 }, {db_id::GH_MOIST2, 24 }, {db_id::GH_MOIST3, 25 }, {db_id::GH_MOIST4, 26 },
