...
#include "../../../../../lib2pi/Objects/Message/include/Message_Handler.hpp"

#include "../../../../../lib2pi/Protocols/HTTP/include/postgresql_interface.hpp"
#include "../../../../../lib2pi/Global_Include/Database_ID_Base.hpp"
#include "../../../../../lib2pi/AnalysisTools/ImageAnalysis_OpenCV/include/Utility_Image.hpp"
#include "../../../../../lib2pi/AnalysisTools/ImageAnalysis_OpenCV/include/Background_Extractor.hpp"
...
public:
    ...
    inline void incrementImageCaptureSuccess(void) { m_container.m_aquicision.amount_of_success++; };
    inline void incrementImageCaptureFail(void)    { m_container.m_aquicision.amount_of_fail++;    };
    inline void incrementImageCaptureTimeout(void) { m_container.m_aquicision.amount_of_timeout++; };
private:
