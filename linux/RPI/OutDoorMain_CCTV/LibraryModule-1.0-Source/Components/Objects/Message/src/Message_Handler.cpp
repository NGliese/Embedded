 ...
 *    -
 */
general_err_t Message_Handler::to_Postgres_Format(const Message_Protocol& msg, std::string* str)
{
#ifdef DEBUG
...
const std::string Message_Handler::to_Postgres_Form(const Message_Protocol& msg)
{
	std::string str;
	// Executable code:
	if(!msg.isValid())
...
const std::string Message_Handler::to_Postgres_Subject(const Message_Protocol& msg)
{
	std::string str;
	// Executable code:
	if(!msg.isValid())
