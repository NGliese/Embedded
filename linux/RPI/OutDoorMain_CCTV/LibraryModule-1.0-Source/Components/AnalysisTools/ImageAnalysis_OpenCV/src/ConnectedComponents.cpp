...
general_err_t ConnectedComponents::drawConnectedComponents(
        const cv::Mat &forground, cv::Mat &drawing) {
    #ifdef DEBUG
    ...
    int ksize = 2;
    cv::morphologyEx(forground, forground,cv::MORPH_OPEN,cv::getStructuringElement(cv::MORPH_RECT,cv::Size_<int>{ksize,ksize} ) );
    cv::morphologyEx(forground, forground,cv::MORPH_CLOSE,cv::getStructuringElement(cv::MORPH_RECT,cv::Size_<int>{ksize,ksize} ) );
...
general_err_t ConnectedComponents::drawConnectedComponentsOpenCV(
        const cv::Mat& forground, cv::Mat& drawing) {
#ifdef DEBUG
  LOG_PRINT_INFO(LOG_TAG, ">> ConnectedComponents::drawConnectedComponents >> ");
  #endif
...
ConnectedComponents::container_t ConnectedComponents::statsConnectedComponents(
        const cv::Mat &forground, int ksize) {
    cv::morphologyEx(forground, forground,cv::MORPH_OPEN,cv::getStructuringElement(cv::MORPH_RECT,cv::Size_<int>{ksize,ksize} ) );
    cv::morphologyEx(forground, forground,cv::MORPH_CLOSE,cv::getStructuringElement(cv::MORPH_RECT,cv::Size_<int>{ksize,ksize} ) );
